...
class TaskSerializer(serializers.ModelSerializer):
    ...
    # assigned_to = serializers.StringRelatedField(read_only=True) Fixed the issue with tasks/tasks
    assigned_to = serializers.PrimaryKeyRelatedField(queryset=User.objects.all())  # <-- writable
